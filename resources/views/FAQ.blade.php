...
<main class="main">
   ...
   <div class="page-content">
      ...
      <div class="container">
          <h2 class="title text-center mb-2">Novaturi Shipping Information</h2>
                  <!-- End .title text-center mb-2 -->
                  <p style="text-align:left;">
                     Welcome to the Shipping Information page of Novaturi, your go-to ecommerce marketplace featuring a diverse collection of unique, handcrafted items from multiple vendors. Our mission is to bring you closer to the world of artisanal beauty, offering products that are handmade, hand-embroidered, or hand-painted, ensuring you receive a piece that is truly one-of-a-kind.<br>
                     <b>Shipping Timeframe:
                     </b> <br>At Novaturi, we understand the excitement and anticipation that comes with each order. We aim to ensure that your treasures reach you in a timely manner. Our standard shipping timeframe is 10-12 business days. If your order surpasses the designated delivery time, please don’t hesitate to get in touch with us at customerservice@novaturi.in for assistance.<br>
                  </p>
            ...
            <div class="card card-box card-sm bg-light">
               ...
               <div id="collapse-1" class="collapse show" aria-labelledby="heading-1" data-parent="#accordion-1">
                  <div class="card-body">
                     ...
                     Our logistics partners will make three delivery attempts. If you're unavailable all three times, the order will be returned to us. If you still want the order or need to update the shipping details, please email your request to customerservice@novaturi.in<br>
                     <b>Can I change the Shipping Address after placing an order?</b><br>
                     You can change the Shipping Address only if the order has not been shipped. Please email your request to customerservice@novaturi.in, and we will do our best to assist you.<br>
                  </div>
                  <!-- End .card-body -->
               </div>
               <!-- End .collapse -->
