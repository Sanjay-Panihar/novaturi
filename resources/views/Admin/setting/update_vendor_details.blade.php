         ...
         <div class="row">
            ...
            @if($slug == "business")
               <div class="box box-warning  col-md-12">
                 ...
                 <!-- /.box-header -->
                 <div class="box-body ">
                   <form role="form" action="{{url('update-vendor-details/business')}}" method="post"
                ...
                @endif
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" name="Business_Category[]" multiple id="businessCategory">
                     ...
                     <div class="form-group">
                       ...
                       <a target="_blank"
                        href="{{url('admin/Businesscatalogue/' . $vendorDetails['Business_catalogue'])}}">View
                        Image</a>
                       <input type="hidden" name="Businesscatalogue"
                        value="{{$vendorDetails['Business_catalogue'] ?? ''}}">
                    @endif
                    @error('Business_catalogue')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                          <label>City</label>
                          <input type="text" name="city" class="form-control" value="{{$vendorDetails['city']}}" />
                        </div>
                        <div class="form-group col-md-6">
                          <label>Country</label>
                        ...
                        <div class="form-group col-md-6">
                          <label>Key Service 1</label>
                          <input type="text" name="keyservice1" class="form-control"
                            value="{{$vendorDetails['keyservice1'] ?? ''}}" maxlength="15" />
                            @error('keyservice1')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                        <div class="form-group col-md-6">
                          <label>Key Service 2</label>
                          <input type="text" name="keyservice2" class="form-control"
                            value="{{$vendorDetails['keyservice2'] ?? ''}}" maxlength="15"/>
                            @error('keyservice2')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                        <div class="form-group col-md-6">
                          <label>Key Service 3</label>
                          <input type="text" name="keyservice3" class="form-control"
                            value="{{$vendorDetails['keyservice3'] ?? ''}}"  maxlength="15"/>
                            @error('keyservice3')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                        ...
                        <textarea class="form-control" rows="3" name="brand" placeholder="Enter Brand Brief" >{{ old('brand', $vendorDetails['brand'] ?? '') }}</textarea>
                        @error('brand')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="3" name="service"
                            placeholder="Enter Key Services"></textarea>
                            @error('service')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
...
<script type="text/javascript">
      var vendorDetails = @json($vendorDetails);
