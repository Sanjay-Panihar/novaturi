               ...
               <div class="table-title">
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        ...
                        <a href="{{url('Add-Edit-section')}}" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Section</span></a>
                  ...
                  @foreach($sections as $section)
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="{{url('delete-section/'. $section['id'])}}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                     </tr>
                  @endforeach
