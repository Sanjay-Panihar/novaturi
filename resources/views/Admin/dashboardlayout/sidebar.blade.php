<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    @else
      ...
      <li
      class="treeview {{ Request::is('supplier-category*') || Request::is('freelance-category*') ? 'active' : '' }}">
      <a href="#">
        <i class="fa fa-dashboard"></i> <span>Business Category</span> <i class="fa fa-angle-left pull-right"></i>
      </a>
      <ul class="treeview-menu">
        <li class="{{ Request::is('supplier-category*') ? 'active' : '' }}"><a
          href="{{ route('supplier-category.index') }}"><i class="fa fa-building"></i> Supplier Category</a></li>
        <li class="{{ Request::is('freelance-category*') ? 'active' : '' }}"><a
          href="{{ route('freelance-category.index') }}"><i class="fa fa-briefcase"></i> Freelance Category</a></li>
      </ul>
      </li>
      <li class="treeview">
      <a href="#">
      ...
      <ul class="treeview-menu">
        <li><a href="{{ url('Sections') }}"><i class="fa fa-list"></i> Sections</a></li>
        <li><a href="{{ url('Categories') }}"><i class="fa fa-book"></i> Categories</a></li>
        <li><a href="{{ url('Products') }}"><i class="fa fa-cube"></i> Products</a></li>
        <li><a href="{{ url('Filters') }}"><i class="fa fa-filter"></i> Filters</a></li>
        <li><a href="{{ url('Add-Edit-Product') }}"><i class="fa fa-plus"></i> Add Product</a></li>
