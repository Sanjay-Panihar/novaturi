...
@section('content')
    ...
    <main class="main">
        	<div class="page-header text-center" style="background-image: url('uiasset/assets/images/page-header-bg.jpg')">
        		<div class="container">
                                        ...
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-action">
                                                    <a href="{{url('mockupsproduct/'.$product['id'])}}" class="btn-product btn-cart"><span>View Details</span></a>
