...
leftmargin="0" marginwidth="0" marginheight="0" width="100%" 
style="border-collapse: collapse; border-spacing: 0; 
 padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
	...
	max-width: 560px;" class="container">
          <tr>
			...
			font-family: sans-serif;" class="header">
              <img border="0" vspace="0" hspace="0" src="img/img-1.jpg" width="200" height="98" alt="The Idea" title="The Idea" />
            </td>
          </tr>
          <tr>
          ...
          <tr>
			...
			padding-bottom: 5px;" class="button">
              <a href="{{ url('Customer/confirm/'.$code) }}">

                <table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;">
                  <tr>
                    <td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: none; 
                    border-collapse: collapse; border-spacing: 0;
                     border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
                        bgcolor="#7ebfb7"><a target="_blank" style="text-decoration: none;
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href=" ">
						{{ url('Customer/confirm/'.$code) }}
