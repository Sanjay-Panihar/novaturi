...
var line4;
 	$(document).ready(function() {
		...
		// Add an event listener to the form for file upload
		$('form').submit(function (e) {
			...
			if (file) {
				...
				reader.onload = function (e) {
					// Create a Fabric.js Image object from the uploaded file
					fabric.Image.fromURL(e.target.result, function (img) {
						// Set the position and other properties of the image
						img.set({
							left: fabric.util.getRandomInt(0, 200),
							top: fabric.util.getRandomInt(0, 400),
							scaleX: 0.5,
    ...
    // Convert the temporary canvas to an image using html2canvas
    html2canvas(tempCanvas.getElement()).then(function(canvas) {
        // Create a download link
        var downloadLink = document.createElement('a');
        downloadLink.href = canvas.toDataURL('image/png');
        downloadLink.download = 'custom_tshirt_with_logo.png';
